...
public class SettingsActivity extends AppCompatActivity {
    ...
    private static int Galletypick=1;
    private Uri ImageUri;
    private StorageReference userProfileImgRe;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        userProfileImgRe= FirebaseStorage.getInstance().getReference().child("profile Images");
        ...
        profileImageView.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivityForResult(galleryIntent,Galletypick);
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if(requestCode==Galletypick&&resultCode==RESULT_OK&&data!=null)
        {
    ...
    private void saveUserData() {
        ...
        if(ImageUri==null){
            ...
            Toast.makeText(this,"user Status is empty",Toast.LENGTH_SHORT).show();
        }
        else{
            progressDialog.setTitle("Account Settings");
            progressDialog.setMessage("Please wait....");
            progressDialog.show();
            final StorageReference filePah=userProfileImgRe.child(FirebaseAuth.getInstance().getCurrentUser().getUid());
            final UploadTask uploadTask=filePah.putFile(ImageUri);
            uploadTask.continueWithTask(new Continuation<UploadTask.TaskSnapshot, Task<Uri>>() {
                ...
                public Task<Uri> then(@NonNull Task<UploadTask.TaskSnapshot> task) throws Exception {
                    ...
                    downloadUrl=filePah.getDownloadUrl().toString();
                    return filePah.getDownloadUrl();
                }
